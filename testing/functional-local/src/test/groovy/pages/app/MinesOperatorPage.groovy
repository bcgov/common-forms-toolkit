...
class MinesOperatorPage extends BaseAppPage {
    ...
    static content = {
      ...
      mineNumber { $("#app > div.v-application--wrap > main > div > div > div > div > div:nth-child(2) > div > div > div > div:nth-child(2) > div > div > form > div:nth-child(3) > div > div.col-sm-5.col-12 > div > div > div.v-input__slot > div > input")}
