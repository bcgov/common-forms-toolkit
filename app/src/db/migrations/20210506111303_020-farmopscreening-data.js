...
const SLUG = require('../../forms/attestations/farmopscreening/constants').SLUG;
const CREATED_BY = 'migration-020';

const FORM_NAME = 'Farm Operator Screening';
  ...
  return Promise.resolve()
    ...
    .then(() => {
      const form = {
        formId: uuidv4(),
        name: FORM_NAME,
        keywords:['covid','attestation','attestations', 'farming', 'operator', 'screening'],
        public: true,
        active: true,
        prefix: PREFIX,
        slug: SLUG,
    ...
    .then(formIds => {
      const form = {
        formId: formIds[0],
        description: 'This is an attestation form for Farm Operator Screening',
        createdBy: CREATED_BY
      };
