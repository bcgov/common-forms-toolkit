  ...
  <v-container>
    ...
    <div class="question-series">
      ...
      <div class="questions">
        ...
        >Farm Operators must have a plan and protocol to deal with workers demonstrating symptoms of COVID-19, including immediate self isolation of the worker and notifying the local health authority.</p>
        <p>
