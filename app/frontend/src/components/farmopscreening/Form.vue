...
import Step5 from '@/components/farmopscreening/Step5.vue';

export default {
  name: 'FarmAttestationForm',
  components: {
    Landing,
    Step1,
    Step2,
  ...
  computed: {
    ...mapGetters('farmOpScreeningForm', ['operationType', 'step', 'submissionComplete']),
    formName() {
  ...
  methods: {
    ...mapMutations('farmOpScreeningForm', ['setOperationType', 'setStep']),
    startForm() {
